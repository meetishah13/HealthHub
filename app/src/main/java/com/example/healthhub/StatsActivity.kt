...
import com.example.healthhub.utils.ChartXValueFormatter
...
class StatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!entries.isEmpty()) {
            ...
            val remainingIntake = findViewById<TextView>(R.id.remainingIntake)
            if (remaining > 0) {
            ...
            val targetIntake = findViewById<TextView>(R.id.targetIntake)
            ...
            val waterLevelView = findViewById<WaveLoadingView>(R.id.waterLevelView)
