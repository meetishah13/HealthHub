...
class BottomSheetFragment(val mCtx: Context) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val etWeight = view.findViewById<TextInputLayout>(R.id.etWeight)
        etWeight.editText!!.setText("" + sharedPref.getInt(AppUtils.WEIGHT_KEY, 0))
        val etWorkTime = view.findViewById<TextInputLayout>(R.id.etWeight)
        etWorkTime.editText!!.setText("" + sharedPref.getInt(AppUtils.WORK_TIME_KEY, 0))
        val etTarget = view.findViewById<TextInputLayout>(R.id.etWeight)
        etTarget.editText!!.setText("" + sharedPref.getInt(AppUtils.TOTAL_INTAKE, 0))
        val etNotificationText = view.findViewById<TextInputLayout>(R.id.etWeight)
        ...
        val etRingtone = view.findViewById<TextInputLayout>(R.id.etRingtone)
        ...
        val radioNotificItervel = view.findViewById<RadioRealButtonGroup>(R.id.radioNotificItervel)
        ...
        val etWakeUpTime = view.findViewById<TextInputLayout>(R.id.etWakeUpTime)
        ...
        val etSleepTime = view.findViewById<TextInputLayout>(R.id.etSleepTime)
